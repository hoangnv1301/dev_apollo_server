...
@section('page-script')
<script src="{{cxl_asset('assets_cms/js/pages-account-settings-account.js')}}"></script>
@endsection
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{cxl_asset('assets_cms/img/avatars/1.png')}}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
